...
const navItems = [
  { label: 'Ana Sayfa', href: '/parent/dashboard', icon: Home },
]
    ...
    <aside className="w-[280px] h-screen fixed left-0 top-0 bg-[#2D5BFF] flex flex-col z-50">
      ...
      <div className="px-4 py-4 border-t border-white/10">
        <div className="flex items-center gap-3">
          <AvatarCircle initials="VL" size="md" className="bg-[#2D5BFF] border-2 border-white/50" />
          <div className="flex-1 min-w-0">
            <p className="text-white text-sm font-medium truncate">Veli</p>
